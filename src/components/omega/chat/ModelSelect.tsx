...
const FREE_GROUP = { id: "free", name: "Free Models", models: FREE_MODELS };
const PAID_GROUPS = Object.entries(groupBy(PAID_MODELS, (m) => m.provider))
  .map(([provider, models]) => ({ id: provider, name: provider, models }));
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent
        ...
        sideOffset={6}
        className={cn(
          "min-w-[280px] max-h-[400px] overflow-y-auto p-2 rounded-xl",
