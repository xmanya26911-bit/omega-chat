    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div
        ...
        style={{
          ...
          borderColor: "oklch(0.5 0.04 260 / 0.3)",
        }}
      >
        {/* Close */}
        <button
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-[var(--omega-fg-dim)]">All plans are completely free — pick what fits</p>
        </div>
            ...
            return (
              <button
                ...
                onClick={async () => {
                  ...
                  if (accessToken) await upgrade(accessToken, plan.id);
                }}
                className={cn(
                  ...
                  active
                    ...
                    : "border-transparent bg-[oklch(0.5_0.02_260_/_0.1)] hover:bg-[oklch(0.5_0.02_260_/_0.18)] hover:border-[oklch(0.5_0.04_260_/_0.3)]"
                )}
              >
                {/* Radio indicator */}
                <div
                  className={cn(
                    ...
                    active
                      ? "bg-[var(--omega-emerald)] text-black"
                      : "bg-[oklch(0.5_0.02_260_/_0.2)] text-[var(--omega-fg-dim)]"
                  )}
                >
                  {plan.icon}
                </div>
                ...
                {/* Active check */}
                {active && (
                  <Check className="absolute right-3 top-3 size-4 text-[var(--omega-emerald)]" strokeWidth={3} />
                )}
              </button>
            );
          })}
        ...
        {/* Footer */}
        <p className="mt-4 text-center text-[10px] text-[var(--omega-fg-dim)]">
          All plans are free — no payment required
        </p>
      </div>
    </div>
  );
